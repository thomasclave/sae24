document.addEventListener("DOMContentLoaded", function() {
    ...
    document.getElementById("reset-button").addEventListener("click", function() {
        ...
        var cases = document.querySelectorAll(".salle-table td.case_grise , .salle-table-ultra td.case_grise_ultra, .salle-table td.case_bleue, .salle-table-ultra td.case_bleue_ultra");
